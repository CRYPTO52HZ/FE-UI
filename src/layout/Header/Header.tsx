    ...
    <div className="h-fit w-full pb-50 fixed px-10 bg-binance-dark">
      <div className="w-fit inline-flex">
        ...
        <div className="w-fit px-5">
          <Link to={"/home"}>
            <span className="font-medium leading-64 hover:text-binance-yellow">
              Markets
            </span>
          </Link>
        </div>
      ...
      <div className="w-fit inline-flex float-end">
        <div className="w-fit h-full pr-2">
          <Link to={"/home"}>
            <span className="leading-64 text-binance-light bg-binance-slight-dark p-2 rounded hover:opacity-80">
              Log In
            </span>
          </Link>
        </div>
        <div className="w-fit h-full">
          <Link to={"/home"}>
            <span className="leading-64 text-binance-dark bg-binance-light-yellow p-2 rounded hover:opacity-80">
              Sign Up
            </span>
          </Link>
        </div>
